...
export default function SavingTransactionForm({
  ...
  return (
    <Dialog isOpen={isOpen} onClose={onClose} title={`Add Funds to ${goal?.title || 'Goal'}`}>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label htmlFor="deposit-amount" className="block text-sm font-medium text-slate-700 mb-1">
            Deposit Amount (₹)
          </label>
          <input
            id="deposit-amount"
