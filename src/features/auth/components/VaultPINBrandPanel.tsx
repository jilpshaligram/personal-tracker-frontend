...
export const VaultPINBrandPanel: React.FC = () => {
  return (
    <div className={authBrandPanelClass}>
      ...
      <div className={authBrandCenterClass}>
        <PinDial />
        <div>
          <div className={authBrandHeadlineClass}>Choose your vault PIN</div>
          <div className={authBrandCopyClass}>
            Pick 4 digits you'll remember. This unlocks VaultSaaS fast, every time.
          </div>
        </div>
      </div>
